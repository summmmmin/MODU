...
//    public ResponseEntity<byte[]> getFile(String attNo, String filePath){
//    	FileVO fileVO = fileService.findFileById(attNo); //파일단건조회
//    	File file = new File((uploadPath+"/upload")+File.separatorChar +filePath, attNo);
//
